...
//        if (frame.empty()) break; // end of video stream
    Mat frame = imread("/home/minzhao/Document/laser_scan_classfication/dataset_ranging_0106/1.jpg");
    ranging::Cross_Property cross_property = cross_center.Crossline_Reg(frame);
    cout << "angle laser: " << atan((cross_property.horizontal[1] - cross_property.horizontal[3]) / (cross_property.horizontal[0] - cross_property.horizontal[2])) << endl;
